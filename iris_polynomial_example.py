...
# Add Gaussian basis functions for each feature.  The mean and standard deviation are specified
# in T_MEAN and T_SIGMA.  This step reduces the error rate from 2.66% to 2% but could be
# overfitting the model. (8 columns)
...
# Solve for the polynomial coefficients using the Least Squares for each iris type
